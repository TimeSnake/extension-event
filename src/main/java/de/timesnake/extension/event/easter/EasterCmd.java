    ...
    public void onCommand(Sender sender, ExCommand<Sender, Argument> cmd, Arguments<Argument> args) {
        ...
        switch (args.getString(0).toLowerCase()) {
            case "egg":
                ...
                sender.sendPluginMessage(ChatColor.PERSONAL + "Egg " + eggArg.toLowerCase());
            ...
            case "enable":
                ...
                sender.sendPluginMessage(ChatColor.PERSONAL + "Enabled easter event");
                break;
            case "disable":
                ExEvent.getInstance().getEasterEvent().setEnabled(false);
                sender.sendPluginMessage(ChatColor.PERSONAL + "Disabled easter event");
        }
    }
